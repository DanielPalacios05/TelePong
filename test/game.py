...
def main():
    ...
    while running:
        ...
        # Pa
        oponent = ""
        if keyboard.is_pressed("up arrow") and keyboard.is_pressed("down arrow"):
            movement = "NONE"
            oponent = client.sendMovement(client_socket,movement)
            player2YFac = 0
        if keyboard.is_pressed("up arrow"):
            ...
            movement = "NONE"
            client.sendMovement(client_socket,movement)
            player2YFac = 0
